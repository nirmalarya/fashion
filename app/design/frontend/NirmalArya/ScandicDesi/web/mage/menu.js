...
define([
    ...
    $.widget('mage.menu', $.ui.menu, {
        ...
        _toggleMobileMode: function () {
            ...
            var custom_mobile_subMenus = this.element.find('.custom-menu-level');
            $.each(custom_mobile_subMenus, $.proxy(function (index, item) {
                var category = $(item).find('> h4 a span').not('.ui-menu-icon').text(),
                    categoryUrl = $(item).find('> h4 a').attr('href'),
                    menu = $(item).find('> .ui-menu');
        ...
        _toggleDesktopMode: function () {
			...
			var custom_subMenus = this.element.find('.level-top');
            $.each(custom_subMenus, $.proxy(function (index, item) {
                var category = $(item).find('> a span').not('.ui-menu-icon').text(),
                    categoryUrl = $(item).find('> a').attr('href'),
                    menu = $(item).find('> .ui-menu');
                ...
                this.categoryParent = $('<li>')
                    .addClass('ui-menu-item custom-all-category')
                    .html(this.categoryLink);

                if (menu.find('.custom-all-category').length === 0) {
                    menu.prepend(this.categoryParent);
                }
