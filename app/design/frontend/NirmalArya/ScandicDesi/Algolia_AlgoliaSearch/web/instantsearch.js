	...
	algoliaBundle.$(function ($) {
		...
		var allWidgetConfiguration = {
			...
			sortBySelector: {
				...
				cssClasses:{root: 'sorter-options' }
			},
			/**
			 * Products' hits
			...
			hits: {
				...
				cssClasses:{
					root: 'products list items product-items',
			...
			currentRefinedValues: {
				...
				cssClasses: {
					root: 'facet  current-refinements-list'
				},
				templates: {
            ...
            /***
            * HitsPerPageSelector
            * Docs: https://community.algolia.com/instantsearch.js/documentation/#hitsperpageselector*
            **/
